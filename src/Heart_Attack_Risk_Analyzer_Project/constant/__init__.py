...
DATA_TRANSFORMATION_CHANGE_FEATURE_NAME_TO_GENDER_KEY = "change_feature_male_to_gender"
DATA_TRANSFORMATION_CONVERT_FEATURES_TO_OBJECTS = "convert_features_to_objects"